...
---
![](D:/1. KULIAH/PSDS/Kelas Dasar/P2/Header KD 0202.png)
...
tanpa tanda pagar.
```{r}
xy ="Shintia mencoba membuat baris"
print(xy)
```
...
typeof(c)
```
Pada R terdapat banyak fungsi analisa, salah satunya adalah fungsi summary.Fungsi ini bisa digunakan untuk menyimpulkan data yang lagi kita proses.
Sebagi contoh :
```{r}
summary(c(1:5))
```
